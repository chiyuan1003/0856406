...
public class PriorityQueueTest {
    static Stream<Arguments> stringIntAndListProvider(){
        //  return stream
        return Stream.of(
                arguments(new int[]{3,8,6,4},new int[] {3,4,6,7}),
                arguments(new int[]{2,5,3,1},new int[] {1,2,3,8}),
                arguments(new int[]{7,4,6,5},new int[] {4,5,6,9}),
                arguments(new int[]{8,0,3,6},new int[] {0,3,6,0}),
                arguments(new int[]{4,2,8,5},new int[] {2,4,5,1})
        );
    }
